...
class DNBSRUThread(QThread):
    ...
    def run(self):
        ...
        success = dnb_sru(self.query, self.metadata, self.base_url, self.progress_signal, self.filename, self.is_running)
...
class SRUQueryApp(QMainWindow):
    def __init__(self):
        ...
        intro_label = QLabel("Mit diesem Tool können Sie die SRU-Schnittstelle der Deutschen Nationalbibliothek "
                            "abfragen und einen Metadatendump herunterladen. <br> Allgemeine Informationen "
        ...
        pixmap = QPixmap("dnb_RGB_125_81.gif")
